      ...
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
            {/* Services Section - Can be dynamically injected */}
            <div>
            ...
            {/* Company Section - Can be dynamically injected */}
            <div>
            ...
            {/* Helpful Links Section - Can be dynamically injected */}
            <div>
              <h3 className="font-medium text-gray-900">Helpful Links</h3>
              <ul className="mt-6 space-y-4 text-sm">
                {quicklinks.map((link) => (
                  <li key={link.name}>
                    <a
            ...
            {/* Legal Section - Can be dynamically injected */}
            {/* <div>
                ...
                {legalLinks.map((link) => (
                  <li key={link.name}>
                    <a
                      href={link.href}
                      className="text-gray-700 transition hover:opacity-75"
                      aria-label={`View ${link.name} policy`}
                    >
                      {link.name}
                    </a>
                  </li>
